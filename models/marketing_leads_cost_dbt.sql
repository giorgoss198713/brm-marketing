...
total_cte AS (SELECT DISTINCT ml.dialer_id, ml.country, ml.campaign_id, cm.affiliate_id,
...
total_cte_cost AS (select date, dialer_id, country, campaign_id, affiliate_id, campaign_country_date_dialer, sum(individual_cost) as total_cost from total_cte group by date, dialer_id, country, campaign_id, affiliate_id, campaign_country_date_dialer)
